<template>
  ...
  >
    ...
    >
      <h1>Privacy Policy for Bayn</h1>

      <p>
        At Bayn, accessible from www.bayn.io, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Bayn and how we use it.
      </p>
      ...
      <p>
        Bayn follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Bayn uses 'cookies'. These cookies are used to
      ...
      <P
        ...
        advertising partners of Bayn.</P
      >

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Bayn, which are sent directly to
      ...
      <p>
        Note that Bayn has no access to or control over these cookies that are
      ...
      <p>
        Bayn's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Bayn does not knowingly collect any Personal Identifiable Information

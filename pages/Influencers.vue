        ...
        <div class="flex justify-center py-[7.75rem] gap-x-[92.7px] relative px-80">
            ...
            <div class="flex relative my-auto z-50 flex-col gap-y-[50px] w-fit">
                ...
                <div class="flex gap-x-[17px]">
                    <button
                        class="text-[14px] leading-[16.44px] font-semibold px-[20px] py-[15px] text-white bg-black rounded-[8px]"
                    >Get Bayn for Android</button>
                    <button
                        class="text-[14px] leading-[16.44px] font-[600] px-[20px] py-[15px] text-black bg-transparent border-[1px] border-black rounded-[8px]"

  ...
  <div class>
    ...
    >
      <h1
        class="
          ...
          lg:text-[48px]
          leading-[45px]
          lg:text-left lg:leading-[73px]
          font-[600]
          text-center text-[#0A2533]
        "
      >
        <div>
          <div
            class="
              ...
              md:absolute
              order-first
              md:top-[18%] md:-right-32
              lg:top-[16%] lg:right-80
            "
          >
            <img class="md:w-3/4 lg:w-full" src="/Ellipse 1.png" />
            <img
              class="absolute md:w-1/2 lg:w-full top-2 right-2"
              src="/Frame 18.png"
            />
          </div>
          <div
            class="
              absolute
              hidden
              md:bottom-[10%] md:-left-[1%]
              lg:bottom-[7%] lg:left-[25%]
            "
          >
            <img
              class="absolute top-0 left-0 md:w-3/4 lg:w-full"
              src="/Ellipse 2.png"
              alt
            />
            <img
              class="absolute hidden md:w-1/2 lg:w-full -left-4 bottom-3"
              src="/Frame 19.png"
            />
          </div>
          <svg
          ...
          <svg
            class="
              absolute
              hidden
              md:block md:top-16 md:left-[5%]
              lg:top-12 lg:left-1/4
            "
            width="224"
            height="236"
            viewBox="0 0 224 236"
          ...
          <svg
            class="absolute lg:flex top-[48%] left-[49%] lg:right-80"
            width="42"
            height="68"
            viewBox="0 0 42 68"
            fill="none"
          ...
          <svg
            class="
              absolute
              hidden
              md:block md:bottom-[22%] md:right-[9%]
              lg:bottom-[26%] lg:right-[23%]
            "
            width="62"
            height="33"
            viewBox="0 0 62 33"
      ...
      >
        ...
        <svg
          class="hidden md:block mx-auto mt-[14px]"
          width="284"
          height="78"
          viewBox="0 0 284 78"
          fill="none"
    ...
    <div class="flex mt-12 xl:px-[110px] 2xl:px-[350px] justify-between">
      <div class="flex relative flex-col gap-y-[24px]">
        ...
        <h1 class="font-[600] text-[48px] leading-[73px] text-[#0A2533]">
          Flow of success
        </h1>
        <div
          class="
